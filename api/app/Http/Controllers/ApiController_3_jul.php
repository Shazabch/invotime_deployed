...
class ApiController extends Controller
{
  ...
  public function get_employees(Request $request)
  {
    ...
    $employees = DB::select("SELECT employees.id,special_id as first_name,last_name,special_id,department_id,qr_barcode,device_role, device_password FROM employees 
...
SELECT employees.id,special_id as first_name,last_name,special_id,department_id,qr_barcode,device_role, device_password FROM employees 
INNER JOIN devices ON employees.company_id = devices.company_id 
