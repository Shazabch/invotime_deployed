...
|
*/
$config['log_path'] = '/var/log/invotime/';
...
$config['sess_cookie_name']		= 'ci_session_pkt';
...
include 'payroll_config.php';
$config['antelope_config'] = $antelope_config;
$config['payroll_config'] = $payroll_config;
