...
class Admin_panel extends CI_Controller {
	...
	function new_company(){
    	...
    	if($row){
    		...
    		$this->db->insert('roles', array("company_id" => $company_id, "job_name" => "Company Admin", "permissions" => "everything", "permissions_level" => "Company"));
    		$role_id = $this->db->insert_id();

    		$this->db->insert('roles', array("company_id" => $company_id, "job_name" => "Outlet Admin", "permissions" => "everything", "permissions_level" => "Outlet", "company_id" => $company_id));
