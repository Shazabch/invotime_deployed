...
class Employees extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['roles'] = $this->db->select('id,job_name')->from('roles')->where_not_in('permissions_level', ['Company', 'Outlet'])->where("company_id = $cid $where_branch_3")->order_by("job_name", "asc")->get()->result();
    ...
    public function getSingleEmployee()
    {
        ...
        $data['roles'] = $this->db->select('id,job_name')->from('roles')->where_not_in('permissions_level', ['Company', 'Outlet'])->where('company_id', $cid)->get()->result();
