			...
			if ($_POST["file_type"] === "pdf") {
				...
				foreach ($all_data as $r) {
					...
					foreach ($r['dates'] as $d) {
						...
						$section_totals[$section]['ot']       = add_time($d->overtime, $section_totals[$section]['ot']);
						...
						// OT Hour
						$sheet->setCellValueByColumnAndRow(9, $row, $d->overtime);
						...
						$total_overtime = add_time($d->overtime, $total_overtime);
						$row++;
					}
				}
