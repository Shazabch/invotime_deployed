...
class Late_break_days extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $details = $this->db->select('id, employee_id, first_name, date, is_break_late, break_late_time, shift_name')
        ...
        foreach ($details as $d) {
            ...
            if ((int)$d->is_break_late === 1) {
                $value = $d->break_late_time ?: 'Late Break';
                $class = 'text-danger';
            }
