...
class Ot_days extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // Fetch details
        $details = $this->db->select('id, employee_id, first_name, date, overtime, is_ot_approved, shift_name')
        ...
        foreach ($details as $d) {
            ...
            if (!empty($d->overtime) && $d->overtime != '00:00') {
                $value = $d->overtime;
                $class = ((int)$d->is_ot_approved === 1) ? 'text-success' : 'text-danger';
            }
