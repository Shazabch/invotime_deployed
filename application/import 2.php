                            ...
                            <div class="panel-body">
                              ...
                              <h4 class="page-title">Employees Basic Info</h4>
                                ...
                                <div id="div-basic-info">
                                	...
                                	<button style="display:none;margin-top:5px"  class="btn-invalid btn btn-danger btn-xs">View Error Details <i style="font-weight:bold" class="fa fa-angle-down"></i></button>
                									<div class="collapse">
                	...
                	$(document).ready(function(){
                      ...
                      var _fields_to_validate = '';
							        ...
							        if(data_file == "basic-info"){
                                        url = 'https://invocore.com.my/pktpt/import/import_basic_info'
							        	_fields_to_validate = 'employee_id,first_name,last_name,department,position,role,outlet,sex'

							        }
                      if(data_file == "allowances"){
                          url = 'https://invocore.com.my/pktpt/import/import_allowances'
                          _fields_to_validate = 'employee_id,allowance_name,amount'

                      }

                      if(data_file == "incentives"){
                          url = 'https://invocore.com.my/pktpt/import/import_incentives'
                          _fields_to_validate = 'employee_id,incentive_name,amount'

                      }

                      if(data_file == "emergency_contacts"){
                          url = 'https://invocore.com.my/pktpt/import/import_emergency_contacts'
                          _fields_to_validate = 'employee_id,first_name,last_name,relation'
                      }

                      if(data_file == "family_members"){
                          url = 'https://invocore.com.my/pktpt/import/import_family_members'
                          _fields_to_validate = 'employee_id,first_name,last_name,relation'
                      }

                      if(data_file == "qualifications"){
                          url = 'https://invocore.com.my/pktpt/import/import_qualifications'
                      ...
                      if(data_file == "languages"){
                          url = 'https://invocore.com.my/pktpt/import/import_languages'
                          _fields_to_validate = 'employee_id,language,writing_skills,speaking_skill'
                      }

                      if(data_file == "skills"){
                          url = 'https://invocore.com.my/pktpt/import/import_skills'
                          _fields_to_validate = 'employee_id,skill,level'
                      }

                      if(data_file == "employment_history"){
                          url = 'https://invocore.com.my/pktpt/import/import_employment_history'
                          _fields_to_validate = 'company_name,period_from,period_to'
                      }
