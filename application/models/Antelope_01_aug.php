...
//****************************************************************************************************************
        ...
        public function employee_groups($xcrud){
          ...
          $cid = get_user()["company_id"];
          $xcrud->where('company_id', $cid);
          $xcrud->fk_relation('Employee Groups','id','employee_groups_relation','group_id','employee_id','employees','id','first_name','company_id ='.$cid.'');
    ...
    return $xcrud->render();
        ...
        public function companies($xcrud){
          ...
          // }
           ...
           $xcrud->fields('name,address,phone,lhdn_no,pic,pic_contact,qr_code,self_clocking,bluetooth,logo');
  ...
  public function merit_deduction_settings($xcrud)
  {
    ...
    $xcrud->change_type('offense', 'select', '', 'Late In / Early Out,Half Day Paid,Half Day Unpaid,Medical Leave,Missing In / Out,Late Break,Absent / Unpaid Leave');

    $xcrud->label(array('company_id' => 'Company', 'branch_id' => 'Branch'));
