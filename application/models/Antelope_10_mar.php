...
class Antelope extends CI_Model
{
  ...
  public function companies($xcrud)
  {
    ...
    //}
    $columns = 'name,organization_id,address,phone,lhdn_no,pic,pic_contact,qr_code,self_clocking,bluetooth,start_day,logo';
    $fields = 'name,address,phone,lhdn_no,pic,pic_contact,qr_code,include_in_qr_code,exclude_from_qr_code,self_clocking,include_in_self_clocking,exclude_from_self_clocking,bluetooth,include_in_bluetooth,exclude_from_bluetooth,start_day,logo';
