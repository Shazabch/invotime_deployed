...
//****************************************************************************************************************
        ...
        public function employee_groups($xcrud){  
          ...
          $cid = get_user()["company_id"];
          $xcrud->where('company_id', $cid);
          $xcrud->fk_relation('Employees','id','employee_groups_relation','group_id','employee_id','employees','id',array('special_id', 'first_name'),'company_id ='.$cid.'', '', ' - ');
    ...
    return $xcrud->render();
        ...
        public function companies($xcrud){
          ...
          // }
           ...
           //}
           $cid = get_user()["company_id"];
           $xcrud->columns('name,organization_id,address,phone,lhdn_no,pic,pic_contact,qr_code,self_clocking,bluetooth,logo');
           $xcrud->fields('name,address,phone,lhdn_no,pic,pic_contact,qr_code,include_in_qr_code,exclude_from_qr_code,self_clocking,include_in_self_clocking,exclude_from_self_clocking,bluetooth,include_in_bluetooth,exclude_from_bluetooth,logo');
        ...
        public function public_holidays($xcrud){
          ...
          $xcrud->relation('include_groups','employee_groups','id','name',array('company_id' => $cid, 'branch_id' => $bid), $order_by = false,
          $multi = true);
          $xcrud->relation('exclude_groups','employee_groups','id','name',array('company_id' => $cid, 'branch_id' => $bid), $order_by = false,
          $multi = true);
