...
//****************************************************************************************************************
        ...
        // }
         ...
         public function leaves($xcrud){
          ...
          //$xcrud->pass_var('company_id', get_user()["company_id"]);
          $xcrud->fields('company_id,name,color,code,is_paid,half_day,void_late_in,void_early_out');
          $xcrud->columns('company_id,name,color,code,is_paid, half_day,void_late_in,void_early_out');
        ...
        public function shifts($xcrud){
          ...
          //echo "nav " . $cid;
          $xcrud->fields('half_day,updated_at,deleted_at,created_at,is_paid,is_leave,void_late_in,void_early_out', true);
          $xcrud->columns('half_day,updated_at,deleted_at,created_at,is_paid,is_leave,void_late_in,void_early_out,auto_clockout_time,excursion_period,fixed_overtime,auto_approve_ot', true);
          ...
          $xcrud->label('is_break_1_work', 'Consider Work Hours');
          $xcrud->label('is_break_2_work', 'Consider Work Hours');
          $xcrud->label('is_break_3_work', 'Consider Work Hours');
          $xcrud->label('is_break_4_work', 'Consider Work Hours');
          $xcrud->label('is_break_5_work', 'Consider Work Hours');
          $xcrud->label('is_break_6_work', 'Consider Work Hours');
  ...
  public function outlets($xcrud)
  {
    ...
    return $xcrud->render();
        ...
        public function work_hours_settings($xcrud)
        {
          ...
          $xcrud->columns('working_hours,half_day');
          $xcrud->fields('working_hours,half_day');
        ...
        public function companies($xcrud){
          ...
          // }
           ...
           //}
           $xcrud->columns('name,organization_id,address,phone,lhdn_no,pic,pic_contact,logo');
           $xcrud->fields('name,address,phone,lhdn_no,pic,pic_contact,logo');
