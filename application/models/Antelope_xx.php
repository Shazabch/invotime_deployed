...
//****************************************************************************************************************
        ...
        // }
         ...
         public function leaves($xcrud){
          ...
          //$xcrud->pass_var('company_id', get_user()["company_id"]);
          $xcrud->fields('company_id,name,color,code,is_paid,half_day');
          $xcrud->columns('company_id,name,color,code,is_paid, half_day');
          ...
          $cid = get_user()["company_id"];
           ...
           $xcrud->after_remove('after_leave_deletion');
        ...
        public function shifts($xcrud){
          ...
          //echo "nav " . $cid;
          $xcrud->fields('half_day,updated_at,deleted_at,created_at,is_paid,is_leave', true);
          $xcrud->columns('half_day,updated_at,deleted_at,created_at,is_paid,is_leave,auto_clockout_time,excursion_period,fixed_overtime,auto_approve_ot', true);
          ...
          $xcrud->after_update('after_shift_updation');
          $xcrud->after_remove('after_shift_deletion');
        ...
        public function termination_reasons($xcrud){
          ...
          $xcrud->after_remove('after_termination_reason_deletion');
        ...
        public function devices($xcrud){
          ...
          $xcrud->after_remove('after_device_deletion');
        ...
        public function days_settings($xcrud){
          ...
          $xcrud->after_remove('after_day_settings_deletion');
          return $xcrud->render();
        }
        ...
        $xcrud->after_remove('after_role_deletion');
        ...
        public function sql_settings($xcrud){
          ...
          // $xcrud->where('holiday_date <= ', date("Y") . "-12-31");
          //
          $xcrud->columns('name, sql_ot1_name, sql_ot1_code, sql_ot1_rate, sql_ot2_name, sql_ot2_code, sql_ot2_rate', false);
          $xcrud->fields('sql_ot1_name, sql_ot1_code, sql_ot1_description, sql_ot1_rate, sql_ot2_name, sql_ot2_code, sql_ot2_description, sql_ot2_rate, sql_ul_name, sql_ul_code, sql_ul_description, sql_ul_rate', false);
