...
//        die();
        ...
        $q = $this->db->select('employees.*,companies.organization_id, companies.lock_radius as is_lockradius, companies.clock_selfie as clock_selfie, companies.performance_data as performance_data, companies.bluetooth_remark as bluetooth_remark, coordinate, branches.invalid_clocking_distance')->from('employees')
            ->join('companies', 'companies.id=employees.company_id')
