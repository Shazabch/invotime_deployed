                                      ...
                                      <h4 class="page-title"><?php echo $pageTitle ?></h4>
                                        ...
                                        <thead>
                                          <tr>
                                            ...
                                            <?php if($selected_month == "late"): ?>
                                              <th scope="col"><strong>Clocked In</strong></th>
                                              <th scope="col"><strong>Late</strong></th>
                                            <?php elseif($selected_month == "late_break"): ?>
                                              <th scope="col"><strong>Late Break</strong></th>
                                            <?php else: ?>
                                              <th scope="col"><strong>Clocked Out</strong></th>
                                              <th scope="col"><strong>Early Out</strong></th>
                                            <?php endif; ?>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          ...
                                          <tr>
                                            <td><?php echo $item->first_name . " (" . $item->special_id . ")" ?>
                                            <br/>
                                                        
                                                        <div style="min-width:100px !important">
                                                     
<a title="Clocking Data" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/manual_clocking_new?month=<?php echo date('m') ?>&emp=<?php echo $item->employee_id ?>"><i style="font-size:15px" class="fa fa-hourglass-half"></i></a>
 
<a title="Employee Report" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/employee_report/<?php echo $item->employee_id ?>?<?php echo "month=" . date('m') ?>"><i style="font-size:15px" class="fa fa-clock"></i></a>

<a title="Employee Summary" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>summary/view/<?php echo $item->employee_id ?>"><i style="font-size:15px" class="fa fa-address-card"></i></a>
                                            ...
                                            <?php if($selected_month == "late"): ?>
                                              <td><?php echo $item->first_in ?></td>
                                              <td><?php echo $item->late_in ?></td>
                                            <?php elseif($selected_month == "late_break"): ?>
                                              <td><?php echo $item->late_break ?></td>
                                            <?php else: ?>
                                              <td><?php echo $item->last_out ?></td>
                                              <td><?php echo $item->early_out ?></td>
                                            <?php endif; ?>
