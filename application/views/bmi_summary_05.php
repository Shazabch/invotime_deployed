	...
	<div class="content container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6 hide-on-print">
				<div class="card-box">
					<div class="row">
						<form method="get" action="<?php echo base_url();?>bmi_summary/view/<?php echo $emp_id;?>/<?php echo $selected_department; ?>">
							<div class="col-md-6">
		...
		window.location = js_base_url + 'bmi_summary/view/' + selectedValue+'/' + selectedDepartment + '/' +params;
	});
		...
		window.location = js_base_url + 'bmi_summary/view/0/' + selectedValue+params;
	});
