                ...
                <?php if ($final_data) : ?>
                  <div class="table-responsive freeze-table">
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <td colspan="<?php echo $max_date; ?>" style="border-right: 0px solid;" class="text-center"><b>Edited Time Logs</b></td>
                          <td colspan="<?php echo $max_date; ?>" style="border-left: 0px solid;" class="text-center"></td>
                        </tr>
                      </thead>
                      <tbody>
                        <?php foreach ($final_data as $f) : ?>
                          <tr style="background-color: lightgray;">
                            ...
                            <td colspan="<?= (($max_date - 20) * 2) + 20; ?>" style="border-left: 0px solid;"><b>Department: <?= $f->employee->department; ?></b></td>
                          </tr>
                          <?= $f->days; ?>
