				...
				<div class="modal-body">
					<form class="m-b-30" name="emp_form" id="emp_form" ng-submit="onSubmit(emp_form.$valid)">
						...
						<div class="row">
							...
							<!-- Race: select preset or enter a custom value -->
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Race</label>
									<select class="select" ng-model="identitySelect.add.race" ng-change="onIdentitySelectChange('add', 'race')">
									...
									<input ng-if="identitySelect.add.race === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.add.race" ng-change="updateCustomIdentityValue('add', 'race')" placeholder="Enter custom race">
								</div>
							</div>

							<!-- Religion: select preset or enter a custom value -->
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Religion</label>
									<select class="select" ng-model="identitySelect.add.religion" ng-change="onIdentitySelectChange('add', 'religion')">
									...
									<input ng-if="identitySelect.add.religion === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.add.religion" ng-change="updateCustomIdentityValue('add', 'religion')" placeholder="Enter custom religion">
								</div>
							</div>

							<!-- Nationality: select preset or enter a custom value -->
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Nationality</label>
									<select class="select" ng-model="identitySelect.add.nationality" ng-change="onIdentitySelectChange('add', 'nationality')">
										<option value="">Select Nationality</option>
										<option value="Malaysian">Malaysian</option>
										<option value="__other__">Other</option>
									</select>
									<input ng-if="identitySelect.add.nationality === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.add.nationality" ng-change="updateCustomIdentityValue('add', 'nationality')" placeholder="Enter custom nationality">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
					...
					<form class="m-b-30" name="emp_edit_form" id="emp_edit_form" ng-submit="onSubmit2(emp_edit_form.$valid)">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Race</label>
									<select class="select" ng-model="identitySelect.edit.race" ng-change="onIdentitySelectChange('edit', 'race')">
										<option value="">Select Race</option>
										<option value="Malay">Malay</option>
										<option value="Chinese">Chinese</option>
										<option value="Indian">Indian</option>
									...
									<input ng-if="identitySelect.edit.race === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.edit.race" ng-change="updateCustomIdentityValue('edit', 'race')" placeholder="Enter custom race">
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Religion</label>
									<select class="select" ng-model="identitySelect.edit.religion" ng-change="onIdentitySelectChange('edit', 'religion')">
										<option value="">Select Religion</option>
										<option value="muslim">Muslim</option>
										<option value="buddhist">Buddhist</option>
										<option value="christian">Christian</option>
									...
									<input ng-if="identitySelect.edit.religion === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.edit.religion" ng-change="updateCustomIdentityValue('edit', 'religion')" placeholder="Enter custom religion">
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Nationality</label>
									<select class="select" ng-model="identitySelect.edit.nationality" ng-change="onIdentitySelectChange('edit', 'nationality')">
										<option value="">Select Nationality</option>
										<option value="Malaysian">Malaysian</option>
										<option value="__other__">Other</option>
									</select>
									<input ng-if="identitySelect.edit.nationality === '__other__'" class="form-control m-t-10" type="text" ng-model="identityCustom.edit.nationality" ng-change="updateCustomIdentityValue('edit', 'nationality')" placeholder="Enter custom nationality">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
...
<script type="text/javascript">
	...
	app.controller('empCtrl', function($scope, $http, $compile) {
		...
		// Race, Religion and Nationality support preset values and a real custom value.
		// The value saved in addModel/editModel is always the actual value, never "Other".
		$scope.identitySelect = {
			add: { race: '', religion: '', nationality: '' },
			edit: { race: '', religion: '', nationality: '' }
		};
		...
		$scope.identityPresets = {
			race: ['Malay', 'Chinese', 'Indian'],
			religion: ['muslim', 'buddhist', 'christian', 'hindu'],
			nationality: ['Malaysian']
		};

		$scope.syncIdentityFields = function(type) {
			var model = type === 'edit' ? $scope.editModel : $scope.addModel;

			['race', 'religion', 'nationality'].forEach(function(field) {
				var value = model[field] || '';
				var presets = $scope.identityPresets[field];

				if (!value) {
					$scope.identitySelect[type][field] = '';
					$scope.identityCustom[type][field] = '';
				} else if (presets.indexOf(value) !== -1) {
					$scope.identitySelect[type][field] = value;
					$scope.identityCustom[type][field] = '';
				} else {
					$scope.identitySelect[type][field] = '__other__';
					$scope.identityCustom[type][field] = value;
				}
			});
		};

		$scope.onIdentitySelectChange = function(type, field) {
			var model = type === 'edit' ? $scope.editModel : $scope.addModel;
			var selected = $scope.identitySelect[type][field];

			if (selected === '__other__') {
				model[field] = $scope.identityCustom[type][field] || '';
			} else {
		...
		$scope.updateCustomIdentityValue = function(type, field) {
			var model = type === 'edit' ? $scope.editModel : $scope.addModel;
			model[field] = $scope.identityCustom[type][field] || '';
		};
		$scope.addModel = {
...
<!-- Employee form tabs: added without changing existing fields, models or actions -->
<style>
/* Employee forms: tabs are only for organizing fields */
#add_employee .emp-form-tabs,
#edit_employee .emp-form-tabs {
    display: flex;
    gap: 8px;
    overflow-x: auto;
    overflow-y: hidden;
...
#add_employee .emp-form-tab,
#edit_employee .emp-form-tab {
    flex: 0 0 auto;
...
#add_employee .emp-form-tab.active,
#edit_employee .emp-form-tab.active {
    background: #337ab7;
    border-color: #337ab7;
    color: #fff;
}

#add_employee .emp-form-tab i,
#edit_employee .emp-form-tab i {
    margin-right: 6px;
}

#add_employee .emp-form-panels,
#edit_employee .emp-form-panels {
    min-height: 300px;
}

#add_employee .emp-form-panel,
#edit_employee .emp-form-panel {
    display: none;
}

#add_employee .emp-form-panel.active,
#edit_employee .emp-form-panel.active {
    display: block;
}

/* Keep the original action buttons outside all tabs */
#add_employee .emp-general-actions,
#edit_employee .emp-general-actions {
    position: sticky;
    bottom: 0;
    z-index: 20;
...
#add_employee .emp-general-actions .btn,
#edit_employee .emp-general-actions .btn {
    margin: 0 !important;
}
...
(function($) {
    ...
    var TAB_CONFIG = {
        general: {
            title: 'General',
            icon: 'fa-user',
            headings: ['Basic Information', 'General Information']
        },
        employment: {
            title: 'Employment',
            icon: 'fa-briefcase',
            headings: ['Departmental Information']
        },
        contact: {
            title: 'Contact',
            icon: 'fa-phone',
            headings: ['Contact Information']
        },
        other: {
            title: 'Other',
            icon: 'fa-info-circle',
    ...
    function getTabKey(heading) {
        var key = null;
        $.each(TAB_CONFIG, function(name, config) {
            if (config.headings.indexOf(heading) !== -1) {
                key = name;
                return false;
            }
        });
    ...
    function buildEmployeeTabs(modalSelector) {
        var $modal = $(modalSelector);
        var $form = $modal.find('form').first();

        if (!$form.length || $form.data('employeeTabsBuilt')) {
            return;
        }

        /* Keep the original bottom action block intact. */
        var $actions = $form.children('.m-t-20.text-center').filter(function() {
            return $(this).find('button, input[type="submit"], input[type="button"]').length > 0;
        }).last();

        $actions.detach();

        /* Keep datalists outside tab panels as well. */
        var $datalists = $form.children('datalist').detach();

        var $nodes = $form.contents().detach();
        var panels = {};
        var panelOrder = [];
        var currentKey = null;
        ...
        $nodes.each(function() {
            ...
            if (node.nodeType === 1 && node.tagName.toLowerCase() === 'h2') {
                var heading = $.trim($node.text());
                var detectedKey = getTabKey(heading);

                if (detectedKey) {
                    currentKey = detectedKey;

                    if (!panels[currentKey]) {
                        panels[currentKey] = $('<div class="emp-form-panel" data-tab="' + currentKey + '"></div>');
                        panelOrder.push(currentKey);
                    }

                    panels[currentKey].append($node);
                    return;
                }
            }

            /* Any content before the first recognized heading belongs to General. */
            if (!currentKey) {
                currentKey = 'general';
                if (!panels[currentKey]) {
                    panels[currentKey] = $('<div class="emp-form-panel" data-tab="general"></div>');
                    panelOrder.push(currentKey);
                }
            }
        ...
        var $tabNav = $('<div class="emp-form-tabs" role="tablist"></div>');
        var $panelWrap = $('<div class="emp-form-panels"></div>');

        panelOrder.forEach(function(key, index) {
            var config = TAB_CONFIG[key];
            var active = index === 0 ? ' active' : '';

            $tabNav.append(
                '<button type="button" class="emp-form-tab' + active + '" data-tab="' + key + '">' +
                    '<i class="fa ' + config.icon + '"></i>' + config.title +
                '</button>'
            );

            if (index === 0) {
                panels[key].addClass('active');
            }

            $panelWrap.append(panels[key]);
        });

        $form.append($tabNav);
        $form.append($panelWrap);

        /* Original buttons are now general actions, outside every tab. */
        if ($actions.length) {
            $actions
                .removeClass('text-center')
                .addClass('emp-general-actions');
            $form.append($actions);
        }

        $form.append($datalists);

        $tabNav.on('click', '.emp-form-tab', function() {
            var key = $(this).data('tab');

            $tabNav.find('.emp-form-tab').removeClass('active');
            $(this).addClass('active');

            $panelWrap.find('.emp-form-panel').removeClass('active');
            $panelWrap.find('.emp-form-panel[data-tab="' + key + '"]').addClass('active');

            /* Return the modal body to the top when switching tabs. */
            var modalBody = $modal.find('.modal-body').get(0);
            if (modalBody) {
                modalBody.scrollTop = 0;
            }
        });

        $form.data('employeeTabsBuilt', true);
    }

    function initEmployeeTabs() {
        buildEmployeeTabs('#add_employee');
        buildEmployeeTabs('#edit_employee');
    }

    $(function() {
        initEmployeeTabs();
        setTimeout(initEmployeeTabs, 300);
    });

    /* Always open the first tab when either form is opened. */
    $(document).on('show.bs.modal', '#add_employee, #edit_employee', function() {
        initEmployeeTabs();
        $(this).find('.emp-form-tab').first().trigger('click');
    });
