		...
		<div class="content container-fluid">
			<div class="row">
				...
				<div class="col-xs-8 text-right m-b-30">
					<a target="_blank" href="<?php echo base_url("employees/resigned_export?type=excel") ?>" class="btn btn-primary rounded">Excel</a>
					<a target="_blank" href="<?php echo base_url("employees/resigned_export") ?>" class="btn btn-primary rounded">PDF</a>
				</div>
			</div>
...
<div style="min-width:150px !important">
	...
	<!-- <a href="javascript:void(0)" class="btn btn-default btn-xs" data-toggle="modal" data-target="#delete_employee" ng-click="setDeleteID('<?php echo $emp->id; ?>')"><i style="font-size:15px" class="fa fa-trash"></i></a> -->
										...
										<td data-sort="<?php echo $emp->hired_on; ?>"><?= !empty($emp->hired_on) ? date("d M, Y", strtotime($emp->hired_on)) : ''; ?></td>
