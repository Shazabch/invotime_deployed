        ...
        <div class="page-content-wrapperx">
            <div class="containerx" style="padding-bottom: 50px;">
                ...
                <style>
                    ...
                    .btn-import-modern.loading .btn-spinner {
                        display: inline-block;
                    }

                    .btn-import-modern.loading .btn-text {
                        opacity: .6;
                    }
                    ...
                    .btn-v2-import:active {
                        transform: translateY(0);
                    }

                    .btn-v2-import.loading {
                        opacity: .75;
                        pointer-events: none;
                    }
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="import-instructions">
                            ...
                            <p>
                                Download the sample Excel template from <a target="_blank" href="<?php echo base_url() ?>assets/import_template_invoTIME_portal.xlsx"><i class="fa fa-file-excel-o" style="margin-right:4px;"></i>here</a> and
                    ...
                    <div>
                        ...
                        <div class="import-card" id="div-basic-info-new">
                            ...
                            <div style="margin-top:10px;font-size:12px;color:#4b5563;line-height:1.5;">
                                <p>
                                    Download the sample Excel template from <a target="_blank" href="<?php echo base_url() ?>assets/import_template_invoTIME_portal.xlsx"><i class="fa fa-file-excel-o" style="margin-right:4px;"></i>here</a> and
                                    <strong>convert this sheet into a separate CSV</strong> before uploading. — any mismatch will cause bank import to fail.
                                </p>
                            </div>
                ...
                <script type="text/javascript">
                    ...
                    function tableGenerator(selector, data) {
                        ...
                        keys = preferredOrder.filter(function(key) {
                        ...
                        data.forEach(function(obj) {
                            var rowClass = '';
                            if (obj.status === 'saved') {
                                rowClass = ' style="background:rgba(34,197,94,.08)"';
                            }
                            if (obj.status === 'skipped') {
                                rowClass = ' style="background:rgba(239,68,68,.08)"';
                            }
                            if (obj.status === 'error') {
                                rowClass = ' style="background:rgba(245,158,11,.10)"';
                            }
                    ...
                    function validateBulkUpdateRows(data) {
                        ...
                        $.each(data, function(i, row) {
                            ...
                            if (!row.Device_ID) {
                                validation_errors.push({
                                    row: rowNumber,
                                    error: 'Device_ID column is required'
                                });
                            ...
                            if (!row.Employee_ID) {
                                validation_errors.push({
                                    row: rowNumber,
                                    error: 'Employee_ID column is required'
                                });
                            }
                            ...
                            if (!row.Position) {
                                validation_errors.push({
                                    row: rowNumber,
                                    error: 'Position column is required'
                                });
                            }
                            ...
                            if (!row.Department) {
                                validation_errors.push({
                                    row: rowNumber,
                                    error: 'Department column is required'
                                });
                            }
                            ...
                            if (!row.Outlet) {
                                validation_errors.push({
                                    row: rowNumber,
                                    error: 'Outlet column is required'
                                });
                            }
                        });
                    ...
                    function handleBulkUpdateFile(file, $card, obj, $dropZone, url) {
                        ...
                        function finishWithRows(rawRows) {
                            ...
                            if (parsedRows.error) {
                                ...
                                tableGenerator($card.find('.collapse'), [{
                                    row: 'Template',
                            ...
                            if (!parsedRows.rows.length) {
                                ...
                                tableGenerator($card.find('.collapse'), [{
                                    row: 'Template',
                                    error: 'No bulk update rows were found in the selected file.'
                                }]);
                                return;
                            }
                        ...
                        if (extension === 'xlsx' || extension === 'xls') {
                            if (typeof XLSX === 'undefined') {
                                ...
                                tableGenerator($card.find('.collapse'), [{
                                    row: 'Template',
                                    error: 'Excel parser library failed to load.'
                                }]);
                                return;
                            }
                            ...
                            reader.onerror = function() {
                                ...
                                tableGenerator($card.find('.collapse'), [{
                                    row: 'Template',
                                    error: 'Failed to load the selected Excel file.'
                                }]);
                            };
                    ...
                    $(document).ready(function() {
                        ...
                        $("input[type=file]").not('#v2-file-input').change(function(evt) {
                            ...
                            if (evt.target.files.length > 0) {
                                ...
                                var fileExt = fileNameLower.split('.').pop();
                                ...
                                function processRows(rowsData) {
                                        ...
                                        var filteredData = rowsData.filter(function(elem) {
                        ...
                        $('#v2-file-input').on('change', function() {
                            ...
                            if ($.fn.select2) {
                                $('#v2-device-selector').next('.select2-container').find('.select2-selection--single').css({
                                    'border-color': '',
                                    'box-shadow': ''
                                });
                            }
                        ...
                        if ($.fn.select2) {
                            ...
                            $('#v2-device-search').on('input', function() {
                                ...
                                if (q === '') {
                                    orig.each(function() {
                                        if ($(this).val() !== '') $sel.append($(this).clone());
                                    });
                                    return;
                                }
                                orig.each(function() {
