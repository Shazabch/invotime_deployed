...
<button title="Approve All Late" data-toggle="tooltip" class="btn btn-default btn-xs all_button" data-emp-id = "<?php echo $emp['id'];?>" data-start_date = "<?php echo $start_date;?>" data-end_date = "<?php echo $end_date;?>"><i style="font-size:15px" class="fa fa-check"></i></button>
