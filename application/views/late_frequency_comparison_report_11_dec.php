                        ...
                        <div class="row">
                                    ...
                                    <div class="panel-body">
                                      <h4 class="page-title"><?php echo $pageTitle ?></h4>
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td><a href="late_frequency_report?month=<?php echo $key ?>&year=<?php echo $_REQUEST["year"] ?>&branch=<?php echo $_REQUEST["branch"] ?>&dep=<?php echo $_REQUEST["dep"] ?>"><b><?php echo date("F", mktime(0, 0, 0, $key, 10)); ?></b></a></td>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <div class="panel panel-primary">
                                  <div class="panel-body">
                                    <!-- <table style="display:none" id="table-chart-1"  class="table">
                                        <thead>
                                          <tr>
                                            <th scope="col"><strong>Month</strong></th>
                                            <th scope="col"><strong>Late Times</strong></th>
                                        ...
                                        <tbody>
                                          ...
                                          <?php foreach($late_data as $key => $item): ?>
                                          <tr>
                                            <td><a href="late_frequency_report?month=<?php echo $key ?>&year=<?php echo $_REQUEST["year"] ?>&branch=<?php echo $_REQUEST["branch"] ?>&dep=<?php echo $_REQUEST["dep"] ?>"><?php echo date("F", mktime(0, 0, 0, $key, 10)); ?></a></td>
