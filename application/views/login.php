   ...
   <div class="main-wrapper" ng-app="myApp" ng-controller="recoveryCtrl">
      <div class="account-page" style="display:none;" >
        ...
        <div class="row" style="height: 100vh">
          ...
          <div class="col-lg-8 hidden-xs hidden-sm hidden-md p-0">
              <img src="<?php echo base_url(). 'assets/invocore-login-page.jpg'; ?>" class="img-responsive p-0" style="height: 100%; width:100%" alt="Your Image">
          </div>

          <!-- Login form section -->
          <div class="col-lg-4 col-xs-12 col-sm-12 col-md-12" style="top: 25%">
        <!-- <div class="col-md-4"> -->
          ...
          <div class="account-box">
            <div class="account-wrapper">
              <ul class="nav nav-pills nav-justified">
                <li class="<?php if(!isset($payroll_error)){ echo "active";} ?>"><a data-toggle="tab" href="#invotime">Invotime</a></li>
                <li class="<?php if(isset($payroll_error)){ echo "active";} ?>"><a data-toggle="tab" href="#payroll">Payroll</a></li>
              </ul>

              <div class="tab-content">
                <div id="invotime" class="tab-pane fade <?php if(!isset($payroll_error)){ echo "in active";} ?>">
                ...
                <?php if(isset($suspended_error)): ?>
                   <div class="alert alert-warning">
                    <strong>License Suspended</strong> Please renew your licence
                  </div>
                <?php endif; ?>
                ...
                <form  method="post" class="form-horizontal m-t-20" action="<?php echo base_url() ?>user_management/login">
                  ...
                  <div class="form-group text-center">
                    <button class="btn btn-primary btn-block account-btn" type="submit">Login to Invotime</button>
                  </div>
              ...
              <div id="payroll" class="tab-pane fade <?php if(isset($payroll_error)){ echo "in active";} ?>">
                <div class="account-logo">
              ...
              <form  method="post" class="form-horizontal m-t-20" action="<?php echo base_url() ?>user_management/payroll_login">
                <div class="form-group form-focus">
                  <label class="control-label">Email</label>
                  <input required="" name="email" class="form-control floating" type="text">
                </div>
                ...
                <div class="form-group text-center">
                  <button class="btn btn-primary btn-block account-btn" type="submit">Login to Payroll</button>
                </div>
...
<script src='<?php echo base_url(); ?>blue/assets/js/loadingOverLay.js'></script></script>
