...
<body>
   ...
   <div class="main-wrapper" ng-app="myApp" ng-controller="recoveryCtrl">
      <div class="account-page">
        <div class="container">
          <h3 class="account-title">Invotime</h3>
          <div class="account-box">
            <div style="font-size: 18px;text-align: center;" class="account-wrapper">
              Invotime is going through periodic maintenance, we will be back shortly.
            </div>
          </div>
        </div>
      </div>
