                                      ...
                                      <h4 class="page-title"><?php echo $pageTitle ?></h4>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                              ...
                                              <select class="form-control" id="sel1" name="scan_distance">
...
<a title="Clocking Data" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/manual_clocking_new?month=<?php echo $_REQUEST['month'] ?>&year=<?php echo $_REQUEST["year"] ?>&emp=<?php echo $c["employee_id"] ?>"><i style="font-size:15px" class="fa fa-hourglass-half"></i></a>
 
<a title="Employee Report" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/employee_report/<?php echo $c["employee_id"] ?>?<?php echo "month=" . $_REQUEST['month'] ?>&year=<?php echo $_REQUEST["year"] ?>"><i style="font-size:15px" class="fa fa-clock"></i></a>

<a title="Employee Summary" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>summary/view/<?php echo $c["employee_id"] ?>?<?php echo "from=01%2F" . $_REQUEST['month'] . "%2F".$_REQUEST['year'] ?>&<?php echo "to=". last_day_of_month($_REQUEST['month']) ."%2F" . $_REQUEST['month'] . "%2F".$_REQUEST['year'] ?>"><i style="font-size:15px" class="fa fa-address-card"></i></a>
                              ...
                              <b><span id="label-shift_assignment-<?php echo $c["id"] ?>" class="color-<?php echo str_replace(' ', '', $c["type"]) ?>"><?php echo $c["type"] ?></span></b>
                                                      ...
                                                      <td style="min-width: 100px;">
                                                        <button id="btn-shift_assignment-<?php echo $c["id"] ?>" data-clocking-id="<?php echo $c["id"] ?>" data-clocking-type="<?php echo $c["type"] ?>" data-clocking-datetime="<?php echo $c["datetime"] ?>" class="btn btn-primary btn-sm" aria-label="Edit Clocking" data-toggle="modal" data-target="#assignment-modal">
                                                          <span class="fa fa-edit" aria-hidden="true"></span>
                                                        </button>
                                                        <?php if(!is_null($c['latlon'])) : ?>
            ...
            <script type="text/javascript">
              ...
              $(document).ready(function(){
                ...
                $("#map-modal").on('hide.bs.modal', function(event) {
                  $("#gmap_canvas").fadeOut(300, function() {$(this).remove()});
                });
