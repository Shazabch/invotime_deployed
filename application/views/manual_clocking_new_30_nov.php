                                            ...
                                            <table style="font-size: 13px" class="table table-striped">
                                              ...
                                              <tbody>
                                                ...
                                                <?php foreach($clockings as $c): ?>
                                                  <tr>
                                                      <td><b>
                                                        <a href="<?php echo base_url() ?>overview/manual_clocking_new?branch=<?php echo $selected_branch_id ?>&emp=<?php echo $c["employee_id"]?>&month=<?php echo $selected_month ?>">
...
<a title="Clocking Data" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/manual_clocking_new?month=<?php echo $selected_month ?>&year=<?php echo $selected_year ?>&emp=<?php echo $c["employee_id"] ?>"><i style="font-size:15px" class="fa fa-hourglass-half"></i></a>
