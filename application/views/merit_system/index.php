									...
									<tr>
										<td><b>
											...
											<div style="min-width:150px !important">
												...
												<?php endif ?>
												<button title="Approve All Offenses" data-toggle="tooltip" class="btn btn-default btn-xs approve_all_button" data-emp-id="<?php echo $emp['id']; ?>" data-start_date="<?php echo $start_date ?>" data-end_date="<?php echo $end_date ?>"><i style="font-size:15px" class="fa fa-check"></i></button>
											</div>
										</td>
...
<script type="text/javascript">
	...
	$(".approve_all_button").on("click", function(e) {
		const btn = $(this);
		const emp_id = $(this).attr('data-emp-id');
		const start = $(this).attr('data-start_date');
		const end = $(this).attr('data-end_date');
