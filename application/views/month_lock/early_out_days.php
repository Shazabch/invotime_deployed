...
<div class="page-wrapper" id="ml-page">
    <div class="container-fluid" style="padding-top: 20px;padding: 20px;">
        <div class="panel">
            ...
            <div class="panel-body" id="ml-early-out-app">
                ...
                <div v-else-if="!selectedLock" style="text-align: center; padding: 40px;">
                    ...
                    <p style="margin-top: 10px; color: #64748b;">Select a Lock Period to view the Early Out sheet</p>
                </div>
                ...
                <div v-else>
                    <div style="margin-bottom: 15px;">
                        <span class="text-danger" style="font-weight: bold;">00:00</span> Early Out &nbsp;&nbsp;&nbsp;
...
new Vue({
    ...
    methods: {
        ...
        fetchData: function() {
            ...
            this.loading = true;
            var self = this;
            axios.get('<?php echo site_url("monthlocks/Early_out_days"); ?>?lock_id=' + this.selectedLock)
                .then(function(response) {
                    if (response.data && response.data.status === 'success') {
