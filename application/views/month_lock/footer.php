<footer
  style="text-align: center; height: 50px; background-color: white; padding-top: 20px; clear: both; position: relative; margin-top: -50px;">
  <b>&copy;<?php echo date('Y'); ?> INVOCORE SDN. BHD. (201801046052). All Rights Reserved.</b>
</footer>
...
<script type="text/javascript" src="<?php echo base_url(); ?>blue/assets/plugins/raphael/raphael-min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>blue/assets/js/app.js?v=1.7"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>blue/assets/js/papaparse.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>blue/assets/js/jquery.json-viewer.js"></script>
