...
<div class="page-wrapper" id="ml-page">
    <div class="container-fluid" style="padding-top: 20px;padding: 20px;">
        <div class="panel">
            ...
            <div class="panel-body" id="ml-ot-app">
                ...
                <div v-if="loading" style="text-align: center; padding: 40px;">
                    ...
                    <p style="margin-top: 10px; color: #64748b;">Loading OT data...</p>
                </div>

                <div v-else-if="!selectedLock" style="text-align: center; padding: 40px;">
                    <i class="fa fa-hand-o-up fa-3x" style="color: #e2e8f0;"></i>
                    <p style="margin-top: 10px; color: #64748b;">Select a Lock Period to view the OT sheet</p>
                </div>

                <div v-else-if="employees.length === 0" style="text-align: center; padding: 40px;">
                    <i class="fa fa-inbox fa-3x" style="color: #e2e8f0;"></i>
                    <p style="margin-top: 10px; color: #64748b;">No OT data found for this period</p>
                </div>

                <div v-else>
                    <div style="margin-bottom: 15px;">
                        <span class="text-success" style="font-weight: bold;">00:00</span> Approved OT &nbsp;&nbsp;&nbsp;
                        <span class="text-danger" style="font-weight: bold;">00:00</span> Rejected OT &nbsp;&nbsp;&nbsp;
                        <span style="color: #ccc;">-</span> No OT
                    </div>
...
new Vue({
    ...
    methods: {
        ...
        fetchData: function() {
            ...
            this.loading = true;
            var self = this;
            axios.get('<?php echo site_url("monthlocks/Ot_days"); ?>?lock_id=' + this.selectedLock)
                .then(function(response) {
                    if (response.data && response.data.status === 'success') {
