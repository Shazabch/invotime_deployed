            ...
            <div class="col-md-12">
                <div class="card-box">
                    <div class="row">
                        ...
                        <form method="get" class="col-md-4" action="<?php echo base_url(); ?>monthly_ot/monthly_view/<?php echo $emp_id; ?>">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".apply-select2").change(function() {
            ...
            window.location = js_base_url + 'monthly_ot/monthly_view/' + selectedValue + '/' + params;
        });
