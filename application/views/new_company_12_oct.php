					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Enter package" ng-model="company.package" required="">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" required="" ng-model="outlet.company">
				...
				<form ng-submit="getXcrud()">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Select Company*</label>
								<select class="form-control" required="" ng-model="company_selected">
									<option value = "">Select a company</option>
									<option value = "{{c.id}}" ng-repeat="c in companies">{{c.name}}</option>
								</select>
							</div>
				...
				<form name="payroll_form" ng-submit="onSubmitPayrollForm(payroll_form.$valid)">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Select Company*</label>
								<select class="form-control" required="" ng-model="payroll.company" ng-change="getOutlets()">
									<option value = "">Select a company</option>
									<option value = "{{c.id}}" ng-repeat="c in companies">{{c.name}}</option>
								</select>
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" required="" ng-model="payroll.outlet" id="outlet-input">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" required="" ng-model="payroll.type">
...
<script type="text/javascript">
	...
	app.controller('adminpanel', function($scope,$http) {
		...
		$scope.getOutlets = function(){
			$('#outlet-input').LoadingOverlay("show",{maxSize:50});
			...
			if($scope.payroll.company == undefined){
				...
				$http.post('<?php echo base_url(); ?>' + 'admin_panel/getOutlets', {id: $scope.payroll.company}, config).then(function (response) {
					if(response.data.success){
		...
		$scope.getXcrud = function(){
			...
			$('body').LoadingOverlay("show",{maxSize:50});
			$http.post('<?php echo base_url(); ?>' + 'admin_panel/getSubscriptions', {company_id : $scope.company_selected}, config).then(function (response) {
