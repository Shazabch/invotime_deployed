<div class="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-lg-3">
              <div class="dash-widget clearfix card-box">
                <!-- <span class="dash-widget-icon"><i class="fa fa-cubes" aria-hidden="true"></i></span> -->
                <div class="dash-widget-info">
                  <a href="overview/manual_clocking_new?month=<?php echo date('m'); ?>&year=<?php echo date('Y'); ?>&scan_distance=invalid"><h3><?php echo $invalid_clocking_distance; ?></h3></a>
                                ...
                                <div class="panel-body p-t-10">
                                  <div class="row">
                                    ...
                                    <div id="graph1x"></div>
                                      ...
                                      <table style="display:none" class="table" id="datatablex">
                                          <thead>
                                              <tr>
                                                  <th></th>
                                                  <th>Ontime</th>
                                          ...
                                          <tbody>
                                            <?php foreach ($attendance_by_department_today as $row): ?>
                                              <tr>
                                      ...
                                      <script type="text/javascript">
                                        Highcharts.chart('graph1x', {
                                          ...
                                          colors: ['#777','#5cb45b','#FF0000','orange','yellow'],
                                          chart: {
                                              type: 'column'
                                          },
                                          title: {
                                              text: 'Attendance Breakdown By Department (Today)'
                                          },
                                          yAxis: {
                                              allowDecimals: false,
                                              title: {
                            ...
                            <div class="row col-md-12">
                              <div class="panel">
                                <div class="panel-body p-t-10">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div id="container_shift_calendar"></div>

                                      <script type="text/javascript">

                                      var d = JSON.parse('<?php  echo $gantt_chart_department_shift;  ?>');
                                      console.log(d);


                                      Highcharts.ganttChart('container_shift_calendar', {
                                        ...
                                        // tooltip: {
                                        //     outside: true,
                                        //     pointFormat: '{point.shift} ({point.code}) <br> Count: {point.count}'
                                        // },
                                        series: [{
                                            name: 'Shift Calendar',
                                            data: d.data,
