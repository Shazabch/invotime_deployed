								...
								<?php foreach($employees as $emp) { ?>
									<tr>
										<td>
											...
											<h2><a style="color:#009ce7" href="javascript:void(0)"><b><?php echo $emp->first_name; ?></b><span><?php echo $emp->job_name; ?>-<?php echo $emp->id; ?></span>
<br/>
				...
				<div class="modal-body">
					<form class="m-b-30" name="emp_form" id="emp_form" ng-submit="onSubmit(emp_form.$valid)">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">SOCSO No.</label>
					...
					<form class="m-b-30" name="emp_edit_form" id="emp_edit_form" ng-submit="onSubmit2(emp_edit_form.$valid)">
							...
							<div id="terminated-fields" ng-show="editModel.employee_status == 'terminated'">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select class="select" ng-model="editModel.termination_reason">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Employee Type</label>
									<select class="select" ng-model="editModel.employee_type">
										<option value="m">Malaysian</option>
										<option value="n">Non Malaysian</option>
									</select>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Permanent Resident</label>
									<select class="select" ng-model="editModel.permanent_resident">
										<option value="yes">Yes</option>
										<option value="no">No</option>
									</select>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Elected To Contribute Under</label>
									<select class="select" ng-model="editModel.etc_under">
										<option value="na">N/A</option>
										<option value="para_3">Paragraph 3</option>
										<option value="para_6">Paragraph 6</option>
									</select>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Overtime</label>
									<select class="select" ng-model="editModel.is_ot">
										<option value="yes">Yes</option>
										<option value="no">No</option>
									</select>
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Early Overtime</label>
									<select class="select" ng-model="editModel.is_early_ot">
										<option value="yes">Yes</option>
										<option value="no">No</option>
									</select>
								</div>
						...
						<?php if (in_array($company_id, companies_allowed_for_att_all())) : ?>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="control-label">Allowance</label>
										<select class="select" ng-model="editModel.is_att_all">
											<option value="yes">Yes</option>
											<option value="no">No</option>
										</select>
									</div>
...
<script type="text/javascript">
	...
	$scope.getPositions = function(){
		...
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/getPositions', {department_id : $scope.addModel.department_id}, config).then(function (response) {
	...
	$scope.getDeductions = function(){
		...
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/getDeductions', {employee_type : $scope.addModel.employee_type, basic_wage : $scope.addModel.basic_wage}, config).then(function (response) {
	...
	$scope.getDeductionsEdit = function(){
		$("body").LoadingOverlay("show",{maxSize:50});
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/getDeductions', {employee_type : $scope.editModel.employee_type, basic_wage : $scope.editModel.basic_wage}, config).then(function (response) {
	...
	$scope.getEditPositions = function(){
		...
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/getPositions', {department_id : $scope.editModel.department_id}, config).then(function (response) {
	...
	$scope.getEmployees = function(){
		...
		// $('body').LoadingOverlay("show",{maxSize:50});
		// $http.post('<?php echo base_url(); ?>' + 'payroll_employees/getEmployees', {department_id : $scope.addModel.department_id}, config).then(function (response) {
	...
	$scope.onSubmit2 = function(valid){
		if(!valid){
            ...
            $http.post('<?php echo base_url(); ?>' + 'payroll_employees/update', $scope.editModel, config).then(function (response) {
	...
	$scope.setEditData = function(id){
		$('body').LoadingOverlay("show",{maxSize:50});
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/getSingleEmployee', {id : id}, config).then(function (response) {
	...
	$scope.delete_employee = function(){
		$('body').LoadingOverlay("show",{maxSize:50});
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/delete_employee', {id : $scope.delete_id}, config).then(function (response) {
			$scope.mainTable = false;
			$scope.getEmployees();
	...
	$scope.reset_device = function(){
		$('body').LoadingOverlay("show",{maxSize:50});
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/reset_device', {id : $scope.editModel.id}, config).then(function (response) {
			$scope.user_device_id = false;
	...
	$scope.access_all_outlet = function(){
		$('body').LoadingOverlay("show",{maxSize:50});
		$http.post('<?php echo base_url(); ?>' + 'payroll_employees/access_all_outlet', {id : $scope.editModel.id}, config).then(function (response) {
			$scope.sync_action = 'SetUserDataAll';
	...
	{
		$http.post("<?php echo base_url(); ?>" + "payroll_employees/get_datalist_options", {}, config)
	...
	$scope.onSubmit = function(valid){
		...
		if(valid) {
			...
			$http.post('<?php echo base_url(); ?>' + 'payroll_employees/save', $scope.addModel, config).then(function (response) {
				if(response.data.success){
					$scope.getEmployees();
					$scope.mainTable = false;
					$scope.addModel = {first_name : '',
