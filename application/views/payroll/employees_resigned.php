...
<div ng-app="myApp" ng-controller="empCtrl" ng-init="get_datalist_options()">
	<div class="page-wrapper">
		<div class="content container-fluid">
			<div class="row">
				<div class="col-xs-4">
					<h4 class="page-title">Resigned Employees</h4>
				</div>
...
<div style="min-width:150px !important">
	...
	<!-- <a href="javascript:void(0)" class="btn btn-default btn-xs" data-toggle="modal" data-target="#delete_employee" ng-click="setDeleteID('<?php echo $emp->id; ?>')"><i style="font-size:15px" class="fa fa-trash"></i></a> -->
										...
										<td><?php echo $emp->resignation_type; ?></td>
										<td data-sort="<?php echo $emp->resignation_date_sort; ?>"><?php echo $emp->resignation_date; ?></td>
										<td><?php echo $emp->resignation_reason; ?></td>
										<td data-sort="<?php echo $emp->resignation_date_sort; ?>"><?php echo $emp->resignation_notice_date; ?></td>
										<!-- <td class="text-right">
											<div class="dropdown">
