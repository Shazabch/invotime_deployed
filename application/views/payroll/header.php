...
<head>
  <meta charset="utf-8" />
  <title><?php echo $this->session->userdata("payroll_user")["outlet_name"] ?> | <?php echo $pageTitle ?></title>
 ...
 -->
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/bootstrap-multiselect/dist/css/bootstrap-multiselect.css">
 ...
 <script src='<?php echo base_url(); ?>blue/assets/js/loadingOverLay.js'></script>
  ...
  <style>
    ...
    .payroll-header {
      background: -webkit-linear-gradient(left, #90ee90 0%,   #008000 100%);
    }
  </style>
...
<body>
  ...
  <div class="main-wrapper">
    ...
    <div class="header payroll-header">
      <div class="header-left">
        <a href="<?php echo base_url() ?>overview" class="logo logo-big">
          <img src="<?php echo base_url() ?>uploads/<?php echo $this->session->userdata("payroll_user")["company_logo"] ?>" height="40" alt="">
        </a>
        <a href="<?php echo base_url() ?>overview" class="logo logo-small">
          <img src="<?php echo base_url() ?>uploads/<?php echo $this->session->userdata("payroll_user")["company_logo"] ?>" height="30" alt="">
        </a>
      </div>
      <a id="toggle_btn" href="javascript:void(0);"><i class="la la-bars"></i></a>
      <div class="page-title-box pull-left">
        <p class="lead" style="color:white">Welcome <?php echo $this->session->userdata("payroll_user")["first_name"] ?>, <b>

            <?php
            echo $this->session->userdata("payroll_user")["outlet_name"]
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle user-link" data-toggle="dropdown" title="Admin">
            ...
            <span style="font-size:12px">
              <?php if($this->session->userdata("payroll_user")["permissions_level"] == "Company"): ?>
                Company Admin
              <?php elseif($this->session->userdata("payroll_user")["permissions_level"] == "Outlet"): ?>
                Outlet Admin
              <?php else: ?>
                Employee
              <?php endif; ?>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url() ?>user_management/payroll_logout">Logout</a></li>
          </ul>
        </li>
      </ul>
      <div class="dropdown mobile-user-menu pull-right">
        ...
        <ul class="dropdown-menu pull-right">
          <!-- <li><a href="<?php echo base_url() ?>my_profile">My Profile</a></li> -->
          <!-- <li><a href="#">Settings</a></li> -->
          <li><a href="<?php echo base_url() ?>user_management/payroll_">Logout</a></li>
        </ul>
      </div>
    </div>