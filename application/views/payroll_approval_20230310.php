...
<div class="page-wrapper" ng-app="myApp" ng-controller="approvalCtrl" ng-init="getData('<?php echo $process_id;?>')">
	
	<div class="content container-fluid">
		<div class="row">
			<div class="col-xs-4">
				<h4 class="page-title">Payroll Approval</h4>
			</div>
		</div>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr ng-repeat="r in report.employees">
									...
									<td ng-show="r.id == null" colspan="8" class="text-center text-danger">Payroll not calculated yet</td>
									<td class="text-center">
										<button class="btn btn-xs btn-danger" ng-if="r.confirm == 'N'" disabled="">Not committed</button>

										<span ng-if="r.confirm == 'Y'">
											<button class="btn btn-xs btn-success" ng-if="r.approved == 'N'" ng-click="approve(r.employee_id, r.process_id)">Approve</button>
											<button class="btn btn-xs btn-danger" ng-if="r.approved == 'Y'" ng-click="disapprove(r.employee_id, r.process_id)">Disapprove</button>
										</span>
					...
					<div class="row" ng-if="report.employees.length > 0">
						<div class="col-md-12">
							<div class="pull-right">
								<button class="btn btn-default" ng-click="approveAll(selected_process, selected_department)">Approve all payrolls</button>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/payroll.js?v=4.1"></script>