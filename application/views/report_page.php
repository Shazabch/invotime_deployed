...
<div class="page-wrapper" ng-app="myApp" ng-controller="reportCtrl" ng-init="getData('<?php echo $process_id;?>')">
	...
	<div class="content container-fluid">
		...
		<div class="row card-box" ng-cloak>
			<form action="<?php echo site_url() ?>payroll/<?php echo $action_link ?>" method="post" target="<?php echo isset($target)?$target:''; ?>">
				<div class="row">
					<div class="col-md-3">
					...
					<div class="col-md-3">
						<label>&nbsp;</label>
						<button class="btn btn-primary btn-block">Download <?php echo $pageTitle; ?></button>
