<div class="page-wrapper" ng-app="myApp" ng-controller="otCtrl">
	<div class="content container-fluid" ng-cloak>
		<div class="row">
			<div class="col-xs-4">
				<h4 class="page-title">Late Break Round Settings</h4>
			</div>
		</div>
...
<script type="text/javascript">
	...
	app.controller('otCtrl', function($scope, $http) {
		...
		$scope.getOtSettings = function() {
			...
			$http.post('<?php echo base_url(); ?>' + 'overview/getSettingsLateBreak', '', config).then(function(response) {
		...
		$scope.outletChange = function() {
			...
			$http.post('<?php echo base_url() ?>' + 'overview/getOutletSettingsLateBreak', {
		...
		$scope.onLDRoundSubmit = function() {
			...
			$http.post('<?php echo base_url() ?>' + 'overview/updateLDRoundSettingsLateBreak', {
