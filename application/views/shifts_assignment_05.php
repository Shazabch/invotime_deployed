                        ...
                        <thead>
                          <tr>
                            ...
                            <?php foreach ($period_of_dates as $period) : ?>
                              ...
                              <th style="font-size: 11px" id="date-<?= $period->format('j') ?>" <?php if (in_array($period->format('Y-m-d'), $public_holidays)) {
                                                                                echo "class='holiday'";
                                                                              } ?>>
                            ...
                            <tr>
                              ...
                              <?php foreach ($period_of_dates as $periodDate) : ?>
                                <?php 
                                  ...
                                  $x = $periodDate->format('j');
                                ?>

                                <td data-date-short-x="<?php echo $periodDate->format('Y-m-') ?>" data-date-x="<?php echo $x ?>" data-emp-id-x="<?php echo $emp["id"] ?>" class="selectable">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#btn-reason-save").on("click", function(e) {
      ...
      data = {
        'data': emp_id + '|' + date + '|' + shift_id
      };
      if (shift_already_assigned) {
        data = {
          'data': emp_id + '|' + date + '|' + shift_id + '|' + remark
        };
      }
