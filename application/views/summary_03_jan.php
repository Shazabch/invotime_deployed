				...
				<div class="card-box">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<a class="btn btn-primary" href="<?php echo base_url() ?>summary/invert_clockings/<?php echo $employee->emp_id ?>/?from=<?php echo urlencode($from_f) ?>&to=<?php echo urlencode($to_f) ?>">Invert Clockings</a>
										...
										<tr>
											...
											<!-- <span class="fa fa-comment" aria-hidden="true"></span> -->
												...
												<?php endif; ?>
													...
													<?php if($is_emp_summary_editable === TRUE) : ?>
																<button style="font-size:11px;max-width:100px;overflow:hidden;white-space: normal;" id="btn-remark-<?php echo $emp_id ?>-<?php echo $d->date; ?>" data-remark="<?php echo $clock->remark ?>" data-id="<?php echo $emp_id ?>" data-date="<?php echo $d->date ?>" type="button" class="btn <?php if(in_array($d->date,$public_holidays)){echo "btn-danger";}else{echo "btn-default";}?> btn-xs" aria-label="Add remark" data-toggle="modal" data-target="#remark-modal">
                                                	<?php endif; ?>
												
												<!-- <span class="fa fa-comment" aria-hidden="true"></span> -->
												<?php if(in_array($d->date,$public_holidays)):?>
												<?php echo $public_holidays_names[array_search($d->date,$public_holidays)] ?>
												<?php elseif(empty($clock->remark)): ?>															
												...
												<?php if($total != "00:00" || $work != "00:00" || $break != "00:00"){ ?>
													<tr>
														...
														<td class="text-center month-overtime <?php if($lateness_time != $lateness_time_deducted){ echo 'strike'; } ?>" colspan="2"><?php echo $month_overtime;?></td>
