							...
							<thead>
								<tr>
									...
									<?php if (!$custom_in_outs && !$tsf_custom_summary): ?>
										<th style="min-width: 70px;">Trip(AB)</th>
											...
											<?php endif; ?>
												...
												<?php if($total != "00:00" || $work != "00:00" || $break != "00:00"){ ?>
													<tr>
														...
														<td class="text-center month-overtime <?php if($lateness_time != $lateness_time_deducted){ echo 'strike'; } ?>" colspan="<?= $custom_in_outs ? 2 : 2; ?>"><?php echo $month_overtime;?></td>
														<?php if (!$tsf_custom_summary): ?>
													...
													<tr>
														...
														<td colspan="<?= $tsf_custom_summary ? 3 : 5; ?>"></td>
													</tr>
