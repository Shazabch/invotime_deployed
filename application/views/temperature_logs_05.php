                  ...
                  <tbody>
                    <?php foreach($final_data as $f): ?>
                      <tr>
                        ...
                        <td colspan="<?= ceil($numberOfDays / 3) ?>" style="border-right: 0px solid;"><b>Employee ID: <?= $f->employee->special_id; ?></b> <a title="Employee Summary" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>summary/view/<?php echo $f->employee->id ?>?<?php echo "from=" . $start_date_f ?>&<?php echo "to=". $end_date_f ?>"><i style="font-size:15px" class="fa fa-address-card"></i></a> <a title="Shift Assignment" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/shifts_assignment?emp=<?php echo $f->employee->id ?>&daterange_filter=<?php echo $start_date_f ?> - <?= $end_date_f ?>"><i style="font-size:15px" class="fa fa-stopwatch"></i></a></td>
