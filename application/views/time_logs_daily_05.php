                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php foreach ($final_data as $f) : ?>
                          <tr>
                            <td style="border-right: 0px solid;"><b><?= $f->employee->special_id; ?></b> <a title="Employee Summary" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>summary/view/<?php echo $f->employee->id ?>?<?php echo "from=01%2F" . $month . "%2F" . $year ?>&<?php echo "to=" . last_day_of_month($month) . "%2F" . $month . "%2F" . $year ?>"><i style="font-size:15px" class="fa fa-address-card"></i></a> <a title="Shift Assignment" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>overview/shifts_assignment?emp=<?php echo $f->employee->id ?>&month=<?php echo $month ?>&year=<?php echo $year ?>"><i style="font-size:15px" class="fa fa-stopwatch"></i></a></td>
