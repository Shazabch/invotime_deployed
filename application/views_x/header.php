...
<html lang="en">
    ...
    <head>
        ...
        if(get_user()["permissions_level"] == "Company"){
          echo get_user()["company_name"];
        }else{
  ...
  <div class="main-wrapper">
    ...
    <div class="header">
          ...
          <a href="<?php echo base_url() ?>overview" class="logo logo-big">
            <img src="<?php echo base_url() ?>uploads/<?php echo (get_user()["permissions_level"] == "Company") ?  get_user()["company_logo"] : get_user()["logo_big"] ?>" height="40" alt="">
          </a>
          <a href="<?php echo base_url() ?>overview" class="logo logo-small">
            <img src="<?php echo base_url() ?>uploads/<?php echo (get_user()["permissions_level"] == "Company") ?  get_user()["company_logo"] : get_user()["logo_small"] ?>" height="30" alt="">
          </a>
                </div>
        <a id="toggle_btn" href="javascript:void(0);"><i class="la la-bars"></i></a>
                <div class="page-title-box pull-left">
          <p class="lead" style="color:white">Welcome <?php echo get_user()["first_name"] ?>, <b>
          ...
          $department_name = get_user()["department_name"];
        ...
        <ul class="nav navbar-nav navbar-right user-menu pull-right">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle user-link" data-toggle="dropdown" title="Admin">
              <span class="user-img"><img class="img-circle" src="<?php echo get_user()["photo"] ?>" width="40">
              <!-- <span class="status online"></span> -->
            </span>
              <span><?php echo get_user()["first_name"] ?></span>
