						...
						<tr>
							...
							<td><div class="table-div">
								<div class="form-group" ng-repeat="a in payroll.allowances">
									<label contenteditable ng-model="a.allowance_name" ng-if="a.db == 'false'">{{a.allowance_name}}</label>
									<label ng-if="a.db == 'true'">{{a.allowance_name}}</label>
							...
							<td><div class="table-div">
								<div class="form-group" ng-repeat="d in payroll.deductions">
									<label contenteditable ng-model="d.name" ng-if="d.db == 'false'">{{d.name}}</label>
									<label ng-if="d.db == 'true'">{{d.name}}</label>
									<span class="checkbox-inline pull-right"><input type="checkbox" ng-checked="d.is_apply == 'true'" ng-if="d.show_apply == 'true'" ng-click="toggleApply($index)">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/payroll.js?v=1.3"></script>