                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                      <h4 class="page-title"><?php echo $pageTitle ?></h4>
                                        ...
                                        <div>
                                            <form action="<?php echo site_url() ?>overview/shifts_assignment" method="get">
                                            <div class="col-md-3">
