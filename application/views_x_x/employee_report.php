                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                      <h4 class="page-title"><?php echo $pageTitle ?> (Clocking) <a title="Employee Summary" data-toggle="tooltip" href="<?php echo site_url() ?>summary/view/<?php echo $emp->id ?>" class="btn btn-default"><i style="font-size:20px" class="fa fa-address-card"></i></a></h4>
