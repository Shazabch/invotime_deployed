								...
								<?php foreach($employees as $emp) { ?>
									<tr>
										<td>
											...
											<h2><a style="color:#009ce7" href="<?php echo base_url(); ?>profile/index/<?php echo $emp->id; ?>"><b><?php echo $emp->first_name; ?></b><span><?php echo $emp->job_name; ?></span>
<br/>
...
<a title="Employee Summary" data-toggle="tooltip" class="btn btn-default btn-xs" href="<?php echo base_url() ?>summary/view/<?php echo $emp->id ?>"><i style="font-size:15px" class="fa fa-address-card"></i></a>
										...
										<td><?php echo $emp->resignation_date; ?></td>
										<td><?php echo $emp->resignation_reason; ?></td>
										<td><?php echo $emp->resignation_notice_date; ?></td>
										<td class="text-right">
											<div class="dropdown">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" ng-model="addModel.race">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" ng-model="addModel.nationality">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" ng-model="addModel.basic_wage" ng-change="getDeductions()">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
					...
					<form class="m-b-30" name="emp_edit_form" id="emp_edit_form" ng-submit="onSubmit2(emp_edit_form.$valid)">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Employee ID <span class="text-danger">*</span></label>
									<input class="form-control" type="text" ng-model="editModel.special_id" required="" readonly>
								</div>
							</div>
							<div class="col-sm-6">  
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Race</label>
									<input class="form-control" type="text" ng-model="editModel.race">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Nationality</label>
									<input class="form-control" type="text" ng-model="editModel.nationality">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div id="terminated-fields" ng-show="editModel.employee_status == 'terminated'">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" ng-model="editModel.termination_reason">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label">Basic Wage</label>
									<input class="form-control" type="text" ng-model="editModel.basic_wage" ng-change="getDeductionsEdit()">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
