  ...
  <div class="col-md-2">
      <div class="form-group">
        ...
        <select class="form-control" id="sel1" name="status">
          <option <?php echo ('late' == $selected_month) ? 'selected' : '' ?> value="late">Late</option>
          <option <?php echo ('ontime' == $selected_month) ? 'selected' : '' ?> value="ontime">On Time</option>
          <option <?php echo ('early' == $selected_month) ? 'selected' : '' ?> value="early">Early</option>
        </select>
      </div>                                               
  </div>
