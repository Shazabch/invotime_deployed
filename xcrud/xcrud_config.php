...
class Xcrud_config
{
    ...
    public static $date_format = 'dd M yy'; // jqueryui date format
    ...
    public static $plugins_uri = 'xcrud/plugins'; // scripts and libraries
    public static $themes_uri = 'xcrud/themes'; // css, images
    public static $lang_uri = 'xcrud/languages'; // js files
